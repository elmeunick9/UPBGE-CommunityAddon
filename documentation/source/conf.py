...
sys.path.insert(0, os.path.abspath("../../project/core/glsl/__global__/"))
sys.path.insert(0, os.path.abspath("../../project/core/com/"))
...
project = 'Community Addon'
copyright = '2017, Robert Planas Jimenez'
author = 'Robert Planas Jimenez (elmeunick9)'
